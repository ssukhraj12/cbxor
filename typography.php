        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> UI KIT <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
              <li> <a href="typography.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Typography</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row ">
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              <div class="panel-heading center">Headings</div>
          ...
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              ...
              <div class="panel-body">
                <p> <strong class="text-uppercase">Lorem Ipsum is simply dummy text of the printing and typesetting industry</strong>. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.<a class="green_text" href="#"> It has survived not only five centuries</a>, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, PageMaker including versions of Lorem Ipsum</p>
        ...
        <div class="row">
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              <div class="panel-heading">Header with Secondary Text</div>
              <div class="panel-body">
          ...
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              <div class="panel-heading">Text Sizes</div>
              <div class="panel-body">
                <h2> Lorem Ipsum is simply dummy text.</h2>
                <br/>
                <div class="well well-large bg"> <span class="semi-bold">GENERAL</span>, LIGHT , <span class="semi-bold">BOLD</span> , <i>ITALICS</i> </div>
          ...
          <div class="col-lg-12">
            <section class="panel default blue_title h2">
              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-md-4">
                    <p class="heading_b">Unordered</p>
                    <ul>
                      <li>Lorem ipsum dolor sit amet</li>
                      <li>Consectetur adipiscing elit</li>
                      <li><strong>Integer molestie lorem at massa</strong></li>
                      <ul>
                        <li class="blue_text">Phasellus iaculis neque</li>
                        <li class="green_text">Purus sodales ultricies</li>
                        <li class="red_text">Vestibulum laoreet porttitor sem</li>
                      </ul>
                      </li>
                      <li>Faucibus porta lacus fringilla vel</li>
                      <li><strong>Aenean sit amet erat nunc</strong></li>
                      <li>Eget porttitor lorem</li>
                    </ul>
                  </div>
                  <div class="col-md-4">
                    <p class="heading_b">Ordered</p>
                    <ol>
                      <li>Lorem ipsum dolor sit amet</li>
                      <li>Consectetur adipiscing elit</li>
                  ...
                  <div class="col-md-4">
                    <p class="heading_b">Unstyeled</p>
                    <ul class="list-unstyled">
                      <li><strong>Lorem ipsum dolor sit amet</strong></li>
                      <li>Consectetur adipiscing elit</li>
                      <li><u>Integer molestie lorem at massa</u></li>
                      <ul class="list-unstyled">
                        <li class="text-danger"><i class="fa fa-square-o"></i> Phasellus iaculis neque</li>
                        <li class="text-success"><i class="fa fa-heart-o"></i><u> Purus sodales ultricies</u></li>
                        <li class="text-warning"><i class="fa fa-bell-o "></i></i> Vestibulum laoreet porttitor sem</li>
                      </ul>
                      </li>
                      <li><strong><i>Faucibus porta lacus fringilla vel</i></strong></li>
                      <li>Aenean sit amet erat nunc</li>
                      <li>Eget porttitor lorem</li>
                    </ul>
                  </div>
        ...
        <div class="row">
              ...
              <div class="panel-body">
                <div class="border">
                  <blockquote>
                    ...
                    <small class="small_size">Someone famous in <cite title="Source Title">Source Title</cite></small> </blockquote>
                </div>
                <div  class="border">
                 <p> <blockquote class="blockquote-reverse">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
          ...
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              <div class="panel-heading">Color & BG</div>
              <div class="panel-body">
                <div class="bs-example bs-example-bg-classes">
                  <p class="pink_text">Lorem Ipsum is simply dummy text. <span class="pink_bg bg_space">bg _color _pink</span> </p>
                  <p class="red_text">Lorem Ipsum is simply dummy text. <span class="red_bg bg_space">bg _color _red</span> </p>
                  <p class="green_text">Lorem Ipsum is simply dummy text.<span class="green_bg bg_space">bg _color _green</span> </p>
                  <p class="blue_text">Lorem Ipsum is simply dummy text. <span class="blue_bg bg_space"> bg _color _blue</span> </p>
                  <p class="magento_text">Lorem Ipsum is simply dummy text. <span class="magento_bg bg_space">bg _color _magento</span> </p>
                  <p class="black_text">Lorem Ipsum is simply dummy text. <span class="black_bg bg_space"> bg _color _black</span> </p>
                  <p class="yellow_text">Lorem Ipsum is simply dummy text. <span class="yellow_bg bg_space">bg _color _yellow</span> </p>
                </div>
              </div>
            </section>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              ...
              <div class="panel-body">
                <p class="text-left space_p">Left aligned text.</p>
                <p class="text-center space_p">Center aligned text.</p>
                <p class="text-right space_p">Right aligned text.</p>
                <p class="text-justify space_p">Justified text.</p>
              </div>
            </section>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
            <section class="panel default blue_title h2">
              <div class="panel-heading">Discription Lists</div>
              <div class="panel-body">
                <div class="border">
                  <dl>
            ...
            <section class="panel default blue_title h2">
              ...
              <div class="panel-body">
                <div class="row-fluid "> <br>
                  <div class="well well-large"> <span class="semi-bold">GENERAL</span>, LIGHT , <span class="semi-bold">BOLD</span> ,ITALICS </div>
                  <div class="well"> <span class="semi-bold">GENERAL</span>, LIGHT , <span class="semi-bold">BOLD</span> ,ITALICS </div>
                  <div class="well"> is the art and technique of arranging type in order to make language visible. The arrangement of type involves the selection of typefaces, point size, line length, leading (line spacing), adjusting the spaces between groups of letters (tracking) </div>
                </div>
              </div>
            </section>
          </div>
