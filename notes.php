  ...
  <div class="inner">
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> APPS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="notes.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Notes</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          <div class="note_btn">
            <button class="btn btn-primary btn-block upload_btn">Add New</button>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="block-web"> <a href="#">
              <h5 class="content-header">Note<span class="pull-right"><i class="fa fa-check note_fa"></i></span></h5>
              </a>
