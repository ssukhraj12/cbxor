        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> APPS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="invoice.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Invoice</b> </a> </li>
            </ul>
          </li>
        ...
        <div class="invoice">
          <div class="invoice_header">
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="btn-group"> <a class="btn btn-sm btn-primary" href="javascript:void(0)"> <i class="fa fa-edit"></i> Edit </a> </div>
                <div class="btn-group"> <a class="btn btn-sm btn-success" href="javascript:void(0)"> <i class="fa fa-plus"></i> Create New </a> </div>
                <div class="btn-group pull-right"> <b>
                  <button type="button" class="btn btn-primary"><i class="fa fa-print"></i></button>
                  </b> <b>
                  <button type="button" class="btn "><i class="fa fa-cloud-download"></i></button>
                  </b> </div>
              </div>
            </div>
          </div>
          <div class="invoice_body">
            <div  class="pull-left">
              <div class="invoice_logo"><img src="images/logo.png" /></div>
              <address>
            ...
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="invoice_total pull-right">
                  <h3><strong>Total: <span class="well_text">$1,596.00</span></strong></h3>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
            <div class="col-sm-12">
              <p class="footer_text">**To avoid any excess penalty charges, please make payments within 30 days of the due date. There will be a 2% interest charge per month on all late invoices.</p>
            </div>
          </div> 
