...
<div class="wrapper">
  <!--\\\\\\\ wrapper Start \\\\\\-->
  <div class="header_bar"><?php include 'layout/header_bar.php'; ?></div>

  <div class="inner">
    <!--\\\\\\\ inner start \\\\\\-->
      <div class="left_nav"><?php include 'layout/leftpanel.php'?></div>
...
<!-- sidebar chats -->
<div><?php include 'layout/sidebar_chats.php'?></div>
<!-- /sidebar chats -->   
