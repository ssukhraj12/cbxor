        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> APPS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="media.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Media Manager</b> </a> </li>
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="input-group-btn cartbox">
                    <button tabindex="-1" data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button"> <span class="caret"></span> <span class="sr-only">Toggle Dropdown</span> </button>
                    <ul role="menu" class="dropdown-menu  cartbox_menu">
                  ...
                  <div class="thumb_image"><img src="images/media/aa.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  <div class="ckbox">
                  ...
                  <div class="thumb_image"><img src="images/media/aa-05.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/aa-10.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/aa-07.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              ...
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/aa-12.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/ee.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/ff.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/gg.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/hh.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
                ...
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/ii.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/jj.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
              <div class="col-xs-6 col-sm-4 col-md-3">
                <div class="thumb">
                  ...
                  <div class="thumb_image"><img src="images/media/kk.png" /></div>
                  <h6>MyDocuments.doc</h6>
                  Added: Jan 03, 2014 </div>
              </div>
          ...
          <div class="col-sm-3">
            <div class="file_sidebar">
              <button class="btn btn-primary btn-block upload_btn">Upload Files</button>
              <a href="#" style="text-decoration:none;"><h6>TAGS </h6></a>
              <ul class="tag_list">
                <li><a>Design</a></li>
                ...
                <li><a>trailer</a></li>
                <li><a>Short film</a></li>
                <li><a>Tuturials</a></li>
                <li><a>Soundtrack</a></li>
              </ul>
              <br/>
              <a href="#" style="text-decoration:none;"><h6>CATEGORY<span class="pull-right">+ Add New Folder</span> </h6></a>
