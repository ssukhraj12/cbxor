        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-folder-open-o"></i> PAGES <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="contact.php"> <span>&nbsp;</span> <i class="fa fa-circle  theme_color"></i> <b class="theme_color">Contact</b> </a> </li>
            </ul>
          </li>
          ...
          <div class="col-lg-7">
            ...
            <div class="panel-body">  
              <div class="inner_form">
					<textarea placeholder="YOUR MESSAGE" rows="5" class="form-control" name="message"></textarea>
				</div>
                <div class="pull-right">
