...
<link href="plugins/tree-view/jquery.treeview.css" rel="stylesheet" type="text/css" />
  ...
  <div class="inner">
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> UI KIT <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="tree.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Tree View</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
		...
		<li class="expandable"><div class="hitarea expandable-hitarea"></div><span class="folder">Folder 1</span>
		...
		<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?1" class="">Item 1</a>
			<ul style="display: none;">
				<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?1.0">Item 1.0</a>
					<ul style="display: none;">
						<li class="last"><a href="?1.0.0">Item 1.0.0</a></li>
					</ul>
				</li>
				<li><a href="?1.1">Item 1.1</a></li>
				<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?1.2">Item 1.2</a>
					<ul style="display: none;">
						<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?1.2.0">Item 1.2.0</a>
						<ul style="display: none;">
							<li><a href="?1.2.0.0">Item 1.2.0.0</a></li>
							<li><a href="?1.2.0.1">Item 1.2.0.1</a></li>
							<li class="last"><a href="?1.2.0.2">Item 1.2.0.2</a></li>
						</ul>
					</li>
						<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?1.2.1">Item 1.2.1</a>
						<ul style="display: none;">
							<li class="last"><a href="?1.2.1.0">Item 1.2.1.0</a></li>
						</ul>
					</li>
						<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?1.2.2">Item 1.2.2</a>
						<ul style="display: none;">
							<li><a href="?1.2.2.0">Item 1.2.2.0</a></li>
							<li><a href="?1.2.2.1">Item 1.2.2.1</a></li>
							<li class="last"><a href="?1.2.2.2">Item 1.2.2.2</a></li>
						</ul>
					</li>
					</ul>
				</li>
		...
		<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?2" class="">Item 2</a>
			<ul style="display: none;">
				<li class="expandable"><div class="hitarea expandable-hitarea"></div><span>Item 2.0</span>
					<ul style="display: none;">
						<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?2.0.0">Item 2.0.0</a>
						<ul style="display: none;">
							<li><a href="?2.0.0.0">Item 2.0.0.0</a></li>
							<li class="last"><a href="?2.0.0.1">Item 2.0.0.1</a></li>
						</ul>
					</li>
					</ul>
				</li>
				<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?2.1">Item 2.1</a>
					<ul style="display: none;">
						<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?2.1.0">Item 2.1.0</a>
						<ul style="display: none;">
							<li class="last"><a href="?2.1.0.0">Item 2.1.0.0</a></li>
						</ul>
					</li>
						<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?2.1.1">Item 2.1.1</a>
						<ul style="display: none;">
							<li><a href="?2.1.1.0abc">Item 2.1.1.0</a></li>
							<li><a href="?2.1.1.1">Item 2.1.1.1</a></li>
							<li class="last"><a href="?2.1.1.2">Item 2.1.1.2</a></li>
						</ul>
					</li>
						<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?2.1.2">Item 2.1.2</a>
						<ul style="display: none;">
							<li><a href="?2.1.2.0">Item 2.1.2.0</a></li>
							<li><a href="?2.1.2.1">Item 2.1.2.1</a></li>
							<li class="last"><a href="?2.1.2.2">Item 2.1.2.2</a></li>
						</ul>
					</li>
					</ul>
				</li>
		...
		<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?3" class="">Item 3</a>
			<ul style="display: none;">
				<li class="open expandable lastExpandable"><div class="hitarea open-hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?3.0">Item 3.0</a>
					<ul>
						<li><a href="?3.0.0">Item 3.0.0</a></li>
						<li class="expandable"><div class="hitarea expandable-hitarea"></div><a href="?3.0.1">Item 3.0.1</a>
							<ul style="display: none;">
								<li><a href="?3.0.1.0">Item 3.0.1.0</a></li>
								<li class="last"><a href="?3.0.1.1">Item 3.0.1.1</a></li>
							</ul>
						</li>
						<li class="expandable lastExpandable"><div class="hitarea expandable-hitarea lastExpandable-hitarea"></div><a href="?3.0.2">Item 3.0.2</a>
							<ul style="display: none;">
								<li><a href="?3.0.2.0">Item 3.0.2.0</a></li>
								<li><a href="?3.0.2.1">Item 3.0.2.1</a></li>
								<li class="last"><a href="?3.0.2.2">Item 3.0.2.2</a></li>
							</ul>
						</li>
					</ul>
				</li>
	...
	<li class="expandable"><div class="hitarea expandable-hitarea"></div><span class="">Item 1</span>
		<ul style="display: none;">
	...
	<li class="expandable"><div class="hitarea expandable-hitarea"></div><span class="">Item 2</span>
		<ul style="display: none;">
			<li class="expandable"><div class="hitarea expandable-hitarea"></div><span>Item 2.0</span>
				<ul style="display: none;">
	...
	<li class="open expandable lastExpandable"><div class="hitarea open-hitarea expandable-hitarea lastExpandable-hitarea"></div><span class="">Item 3</span>
		<ul style="display: none;">
			<li class="open collapsable lastCollapsable"><div class="hitarea open-hitarea collapsable-hitarea lastCollapsable-hitarea"></div><span class="">Item 3.0</span>
				<ul>
...
<script src="plugins/tree-view/jquery.cookie.js"></script>
<script src="plugins/tree-view/jquery.treeview.js"></script>
<script type="text/javascript" src="plugins/tree-view/demo.js"></script>
