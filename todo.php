  ...
  <div class="inner">
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> APPS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              <li> <a href="todo.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">To-Do</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
       ...
       <div class="todo_body ">
       	<h5 class="red_bg"> <i class="fa fa-warning"></i>  Critical Tasks (
<small>1</small>
)</h5>
		<ul class="group_sortable1">
        	<li>
            	<span class=""><input name="" type="checkbox" value="" /></span>
                <p><strong>Ticket #17643</strong>
...
<h5 class="orange_bg"> <i class="fa fa-warning"></i>  Pending Tasks (
<small>1</small>
)</h5>
<ul class="group_sortable1">
        	<li>
...
<h5 class="blue_bg"> <i class="fa fa-warning"></i> Completed Tasks (
<small>1</small>
)</h5>
<ul class="group_sortable1">
        	<li>
