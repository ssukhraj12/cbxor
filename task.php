    ...
    <div class="left_nav">
      ...
      <div class="left_nav_slidebar">
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> APPS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              <li> <a href="todo.php"> <span>&nbsp;</span> <i class="fa fa-circle"></i> <b>To-Do</b> </a> </li>
              <li> <a href="task.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Task</b> </a> </li>
      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="task-header red_task">Task heading <span><i class="fa fa-clock-o"></i>3 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
                <p>Task3:Lorem Ipsum is simply dummy text .</p>
              </div>
              <div class="col-sm-3">
                <div class="pull-right"><span>October 5, 2014</span></div>
                <div class="pull-right"><span>October 7, 2014</span></div>
                <div class="pull-right"><span>October 9, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              <div class="progress ">
                <div style="width: 40%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-danger"> <span class="sr-only">60% Complete</span> </div>
              </div>
              </label>
              <span class="label btn-danger">40%</span>
              <div class="pull-right">
            ...
            <div class="task-header blue_task">Task heading <span><i class="fa fa-clock-o"></i>9 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>August  9, 2014</span></div>
                <div class="pull-right"><span>August  12, 2014</span></div>
                <div class="pull-right"><span>August  18, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              ...
              <section class="panel default green_border vertical_border h1">
            <div class="task-header green_task">Task heading <span><i class="fa fa-clock-o"></i>2 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>August  12, 2014</span></div>
                <div class="pull-right"><span>August  13, 2014</span></div>
                <div class="pull-right"><span>August  14, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              <div class="progress">
                <div style="width:70%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-success"> <span class="sr-only">60% Complete</span> </div>
              </div>
              </label>
            ...
            <div class="task-header orange_task">Task heading <span><i class="fa fa-clock-o"></i>1 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>October 7, 2014</span></div>
                <div class="pull-right"><span>October 12, 2014</span></div>
                <div class="pull-right"><span>October 16, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              ...
              <span class="label btn-warning">60%</span>
              <div class="pull-right">
                <ul class="footer-icons-group">
                  <li><a href="#"><i class="fa fa-pencil"></i></a></li>
                  <li><a href="#"><i class="fa fa-trash-o"></i></a></li>
              ...
              <section class="panel default blue_border vertical_border h1">
            <div class="task-header blue_task">Task heading <span><i class="fa fa-clock-o"></i>6 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>October 8, 2014</span></div>
                <div class="pull-right"><span>October 10, 2014</span></div>
                <div class="pull-right"><span>October 12, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              <div class="progress">
                <div style="width: 80%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-info"> <span class="sr-only">60% Complete</span> </div>
              </div>
              </label>
              <span class="label btn-primary">80%</span>
              <div class="pull-right">
                <ul class="footer-icons-group">
                  <li><a href="#"><i class="fa fa-pencil"></i></a></li>
                  <li><a href="#"><i class="fa fa-trash-o"></i></a></li>
            ...
            <div class="col-md-6">
            <section class="panel default red_border vertical_border h1">
            <div class="task-header red_task">Task heading <span><i class="fa fa-clock-o"></i>7 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>September 3, 2014</span></div>
                <div class="pull-right"><span>September 5, 2014</span></div>
                <div class="pull-right"><span>September 9, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              ...
              <section class="panel default green_border vertical_border h1">
            <div class="task-header green_task">Task heading <span><i class="fa fa-clock-o"></i>3 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>August 4, 2014</span></div>
                <div class="pull-right"><span>August 19, 2014</span></div>
                <div class="pull-right"><span>August 23, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              <div class="progress">
                <div style="width:75%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-success"> <span class="sr-only">60% Complete</span> </div>
              </div>
              </label>
              <span class="label btn-success">75%</span>
              <div class="pull-right">
                <ul class="footer-icons-group">
                  <li><a href="#"><i class="fa fa-pencil"></i></a></li>
                  <li><a href="#"><i class="fa fa-trash-o"></i></a></li>
              ...
              <section class="panel default orange_border vertical_border h1">
            <div class="task-header orange_task">Task heading <span><i class="fa fa-clock-o"></i>5 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>September 1, 2014</span></div>
                <div class="pull-right"><span>September 3, 2014</span></div>
                <div class="pull-right"><span>September 6, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              ...
              <section class="panel default orange_border vertical_border h1">
            <div class="task-header orange_task">Task heading <span><i class="fa fa-clock-o"></i>4 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
              ...
              <div class="col-sm-3">
                <div class="pull-right"><span>October 6, 2014</span></div>
                <div class="pull-right"><span>October 12, 2014</span></div>
                <div class="pull-right"><span>October 15, 2014</span></div>
              </div>
            </div>
            <div class="task-footer">
              <label class="pull-left">
              <div class="progress">
                <div style="width:85%;" aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" role="progressbar" class="progress-bar progress-bar-warning"> <span class="sr-only">60% Complete</span> </div>
              </div>
              </label>
              <span class="label btn-warning">85%</span>
              <div class="pull-right">
                <ul class="footer-icons-group">
                  <li><a href="#"><i class="fa fa-pencil"></i></a></li>
                  <li><a href="#"><i class="fa fa-trash-o"></i></a></li>
              ...
              <section class="panel default blue_border vertical_border h1">
            <div class="task-header blue_task">Task heading <span><i class="fa fa-clock-o"></i>2 hours</span> </div>
            <div class="row task_inner inner_padding">
              <div class="col-sm-9">
                <p>Task1:Lorem Ipsum is simply dummy text .</p>
                <p>Task2:Lorem Ipsum is simply dummy text .</p>
            ...
            <div class="task-footer">
              ...
              <span class="label btn-primary">60%</span>
              <div class="pull-right">
                <ul class="footer-icons-group">
                  <li><a href="#"><i class="fa fa-pencil"></i></a></li>
                  <li><a href="#"><i class="fa fa-trash-o"></i></a></li>
