        ...
        <ul>
          <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> DASHBOARD <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="layouts.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color "></i> <b class="theme_color">Layouts</b> </a> </li>
                  ...
                  <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-primary btn-xs btn-mini">Apply here</button></td>
                      </tr>
                      <tr>
