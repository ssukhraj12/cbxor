        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-folder-open-o"></i> PAGES <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul style="display:block">
              ...
              <li> <a href="search.php"> <span>&nbsp;</span> <i class="fa fa-circle  theme_color"></i> <b class="theme_color">Search</b> </a> </li>
      ...
      <div class="container clear_both padding_fix">
        ...
        <form class="">
                          <div class="form-group search_group ">
                                ...
                                <span class=""><button class="btn btn-primary btn_space" type="button"><i class="fa fa-search"></i> Search</button></span>
                          </div>
                      </form>
                      
             <p>About 4,350,000 results (0.30 seconds) </p>         
             <div class="results">
             <h4>UI Elements</h4>
