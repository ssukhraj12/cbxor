      ...
      <ul>
        ...
        <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-glass"></i> EXTRA <span class="plus"><i class="fa fa-plus"></i></span></a>
          <ul class="opened" style="display:block">
            ...
            <li> <a href="gallery.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Gallery</b> </a> </li>
  ...
  <div class="contentpanel">
    ...
    <div class="container clear_both padding_fix">
      ...
      <div class="row center">
       ...
       <div class="panel-heading border">Gallery</div>
       </section>
       </div>
       </div>
			...
			<div class="superbox">
				<div class="superbox-list">
					<img src="images/superbox/superbox-thumb-1.jpg" data-img="images/superbox/superbox-full-1.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-2.jpg" data-img="images/superbox/superbox-full-2.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-3.jpg" data-img="images/superbox/superbox-full-3.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-4.jpg" data-img="images/superbox/superbox-full-4.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-5.jpg" data-img="images/superbox/superbox-full-5.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-6.jpg" data-img="images/superbox/superbox-full-6.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-7.jpg" data-img="images/superbox/superbox-full-7.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-8.jpg" data-img="images/superbox/superbox-full-8.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-9.jpg" data-img="images/superbox/superbox-full-9.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-10.jpg" data-img="images/superbox/superbox-full-10.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-11.jpg" data-img="images/superbox/superbox-full-11.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-12.jpg" data-img="images/superbox/superbox-full-12.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-13.jpg" data-img="images/superbox/superbox-full-13.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-14.jpg" data-img="images/superbox/superbox-full-14.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-15.jpg" data-img="images/superbox/superbox-full-15.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-16.jpg" data-img="images/superbox/superbox-full-16.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-17.jpg" data-img="images/superbox/superbox-full-17.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-18.jpg" data-img="images/superbox/superbox-full-18.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-19.jpg" data-img="images/superbox/superbox-full-19.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-20.jpg" data-img="images/superbox/superbox-full-20.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-21.jpg" data-img="images/superbox/superbox-full-21.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-22.jpg" data-img="images/superbox/superbox-full-22.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-23.jpg" data-img="images/superbox/superbox-full-23.jpg" alt="" class="superbox-img">
				</div><!--
				--><div class="superbox-list">
					<img src="images/superbox/superbox-thumb-24.jpg" data-img="images/superbox/superbox-full-24.jpg" alt="" class="superbox-img">
				</div>
...
<script src="plugins/map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="plugins/map/jquery-jvectormap-world-mill-en.js"></script>
<script src="plugins/gallery/superbox.js"></script>
<script>
    $(function(){
      $('#world-map').vectorMap();
    });
