        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-users icon"></i> APPS <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="ticket.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Ticket Support</b> </a> </li>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="ticket_form">
              ...
              <div class="btn-group"> <a href="javascript:void(0)" class="btn btn-sm ticket_btn_2">Publice</a> </div>
              <br/>
              <br/>
              ...
              <a href="#">
                <div class="input-group pull-left">
                  <input type="text" class="form-control" placeholder="This ticket is for..." >
                </div>
            ...
            <div class="ticket_open">
              <div class="ticket_open_heading">
                ...
                <div class="ticket_open_search">
                  <div class="btn-group"><i class="fa fa-search"></i></div>
                  <div class="input-group pull-left">
                    <input type="text" class="form-control" placeholder="Search Resulets...">
                  </div>
                </div>
              </div>
              <div class="clearfix"></div>
