  ...
  <div class="inner">
    ...
    <div class="left_nav">
      ...
      <div class="left_nav_slidebar">
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-folder-open-o"></i> PAGES <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened"  style="display:block">
              ...
              <li> <a href="about.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">About</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
       ...
       <div class="panel-heading border">About Us</div>
       </section>
       </div>
       </div>
       ...
       <div class="our_office"><img src="images/bfdfh.png" alt="j,h" /></div>
       </div>
       </section>
       </div>
       </div>
        ...
        <h5>Bob Nilson  <br/><small>Chief Executive Officer / CEO</small></h5>
        <div class="team_image"><img src="images/team/team-4.png" /></div>
        <div class="team-info"><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,</p>
        ...
        <div class="col-lg-3 col-sm-6">
        <h5>Bob Nilson  <br/><small>Chief Executive Officer / CEO</small></h5>
        <div class="team_image"><img src="images/team/team-3.png" /></div>
        <div class="team-info"><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,</p>
        <ul class="social_icons pull-right">
        <li><a href="#"><i class="fa fa-envelope-o"></i></a></li>
        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="col-lg-3 col-sm-6">
        <h5>Bob Nilson  <br/><small>Chief Executive Officer / CEO</small></h5>
        <div class="team_image"><img src="images/team/team-2.png" /></div>
        <div class="team-info"><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,</p>
        <ul class="social_icons pull-right">
        <li><a href="#"><i class="fa fa-envelope-o"></i></a></li>
        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="col-lg-3 col-sm-6">
        <h5>Bob Nilson <br/><small>Chief Executive Officer / CEO</small></h5>
        <div class="team_image"><img src="images/team/team-1.png" /></div>
        <div class="team-info"><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit,</p>
        <ul class="social_icons pull-right">
       <li><a href="#"><i class="fa fa-envelope-o"></i></a></li>
        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
