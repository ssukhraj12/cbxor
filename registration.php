...
<div class="wrapper">
 ...
 <form role="form" class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input type="email" placeholder="Full Name" id="inputEmail3" class="form-control">
        </div>
      </div>
      <div class="form-group">
      <div class="col-sm-10">
          <input type="email" placeholder="Address" id="inputEmail3" class="form-control">
        </div>
      </div>
      <div class="form-group">
      <div class="col-sm-10">
      ...
      <div class="form-group">
      <div class="col-sm-10">
          <input type="email" placeholder="City/Town" id="inputEmail3" class="form-control">
        </div>
      </div>
      <div class="form-group">
      <div class="col-sm-10">
          <input type="email" placeholder="User Name" id="inputEmail3" class="form-control">
        </div>
      </div>
      <div class="form-group">
