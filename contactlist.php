        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-glass"></i> EXTRA <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="contactlist.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Contact List</b> </a> </li>
        ...
        <div class="row">
          <div class="col-sm-9">
            ...
            <div class="contact_people">
            	<a href="#"><img src="images/contact people/aa-1.png" /></a>
            ...
            <div class="contact_people">
             ...
             <div class="col-sm-6">
            <div class="contact_people">
            	<a href="#"><img src="images/contact people/aa-7.png" /></a>
                <div class="contact_people_body">
                	<h5>John doe</h5>
                    <span><i class="fa fa-map-marker"></i>New York,USA</span>
                    <span><i class="fa fa-briefcase"></i>Software Enginner at<a href="#"> abc.com</a></span>
            ...
            <div class="col-sm-6">
            <div class="contact_people">
            	<a href="#"><img src="images/contact people/aa-6.png" /></a>
                <div class="contact_people_body">
                	<h5>John doe</h5>
                    <span><i class="fa fa-map-marker"></i>New York,USA</span>
                    <span><i class="fa fa-briefcase"></i>Software Enginner at<a href="#"> abc.com</a></span>
            ...
            <div class="col-sm-6">
            <div class="contact_people">
            	<a href="#"><img src="images/contact people/aa-3.png" /></a>
                <div class="contact_people_body">
                	<h5>John doe</h5>
                    <span><i class="fa fa-map-marker"></i>New York,USA</span>
                    <span><i class="fa fa-briefcase"></i>Software Enginner at<a href="#"> abc.com</a></span>
            ...
            <div class="col-sm-6">
            <div class="contact_people">
            	<a href="#"><img src="images/contact people/aa-8.png" /></a>
                <div class="contact_people_body">
                	<h5>John doe</h5>
                    <span><i class="fa fa-map-marker"></i>New York,USA</span>
                    <span><i class="fa fa-briefcase"></i>Software Enginner at<a href="#"> abc.com</a></span>
          ...
          <div class="col-sm-3">
            <div class="file_sidebar">
              <button class="btn btn-primary btn-block upload_btn">Add new contact</button>
              
              <br/>
             <a href="javascript:void(0);" style="text-decoration:none;"> <h6>CATEGORY</h6></a>
              <div class="file_sidebar_list">
                <ul>
                  <li><a><i class="fa fa-users"></i>Family</a></li>
                  <li><a><i class="fa fa-building-o"></i>Business</a></li>
                  <li><a><i class="fa fa-user"></i>Personal</a></li>
                  <li><a><i class="fa fa-users"></i>Friends</a></li>
                  <li><a><i class="fa fa-twitter-square"></i>Following</a></li>
                  <li><a><i class="fa fa-exclamation-triangle"></i>Important</a></li>
                  <li><a><i class="fa fa-exclamation-triangle"></i>VIP</a></li>
