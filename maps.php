  ...
  <div class="inner">
        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-glass"></i> EXTRA <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened"  style="display:block">
              ...
              <li> <a href="maps.php"><span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Maps</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        ...
        <div class="row">
          <div class="col-md-12"><div id="world-map" style="width:100%; height:400px;"></div></div>
        ...
        <p>&nbsp;</p>
         <div class="row">
          <div class="col-md-12"><div id="world-map-markers" style="width:100%; height:400px;"></div></div>
...
<script src="plugins/map/jquery-jvectormap-in-merc-en.js"></script>
<script src="plugins/map/map-edit.js"></script>
