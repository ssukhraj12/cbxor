        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> UI KIT <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="icons.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Icons</b> </a> </li>
    ...
    <div class="contentpanel">
      ...
      <div class="container clear_both padding_fix">
        ...
        <ul class="nav nav-tabs" id="myTab">
          <li class="active"><a data-toggle="tab" href="#icons">Icons</a></li>
          <li class=""><a data-toggle="tab" href="#icons-style">Icons style</a></li>
          <li class=""><a data-toggle="tab" href="#animation">animation</a></li>
        </ul>
        <div class="tab-content" id="myTabContent">
          <div id="icons" class="tab-pane fade active in">
            <div class="white_bg">
              <div id="new">
          ...
          <div id="icons-style" class="tab-pane fade">
            <div class="row">
              <div class="col-lg-4">
                <section class="panel default blue_title h2">
                  <div class="panel-heading">Semiround icons</div>
                  <div class="panel-body center">
                    <div class="row fontawesome-icon-list">
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/ambulance"><i class="fa fa-briefcase squre semiround"></i> fa-ambulance</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/h-square"><i class="fa fa-h-square semiround"></i> fa-h-square</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/hospital-o"><i class="fa fa-hospital-o semiround"></i> fa-hospital-o</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/medkit"><i class="fa fa-medkit semiround"></i> fa-medkit</a></div>
                    </div>
                  </div>
                </section>
              </div>
              <div class="col-lg-4">
                <section class="panel default blue_title h2">
                  <div class="panel-heading">Squre icons</div>
                  <div class="panel-body center">
                    <div class="row fontawesome-icon-list">
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/ambulance"><i class="fa fa-briefcase squre"></i>fa-ambulance</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/h-square"><i class="fa fa-h-square squre"></i> fa-h-square</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/hospital-o"><i class="fa fa-hospital-o squre"></i> fa-hospital-o</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/medkit"><i class="fa fa-medkit squre"></i> fa-medkit</a></div>
                    </div>
                  </div>
                </section>
              </div>
              <div class="col-lg-4">
                <section class="panel default blue_title h2">
                  <div class="panel-heading">Round icons</div>
                  <div class="panel-body center">
                    <div class="row fontawesome-icon-list">
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/ambulance"><i class="fa fa-briefcase squre round"></i> fa-ambulance</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/h-square"><i class="fa fa-h-square round"></i> fa-h-square</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/hospital-o"><i class="fa fa-hospital-o round"></i> fa-hospital-o</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/medkit"><i class="fa fa-medkit round"></i> fa-medkit</a></div>
                    </div>
                  </div>
                </section>
              </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <section class="panel default blue_title h2">
                  <div class="panel-heading">icon color</div>
                  <div class="panel-body center">
                    <div class="row fontawesome-icon-list">
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/ambulance"><i class="fa fa-arrows  red"></i> fa-arrows</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/h-square"><i class="fa fa-h-square  green"></i> fa-h-square</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/hospital-o"><i class="fa fa-hospital-o  blue"></i> fa-hospital-o</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/medkit"><i class="fa fa-medkit magento"></i> fa-medkit</a></div>
                    </div>
                  </div>
                </section>
              </div>
              <div class="col-lg-6">
                <section class="panel default blue_title h2">
                  <div class="panel-heading">icon size</div>
                  <div class="panel-body center">
                    <div class="row fontawesome-icon-list">
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/ambulance "><i class="fa fa-arrows  icon_size"></i> fa-arrows</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/h-square "><i class="fa fa-h-square  icon_size2"></i> fa-h-square</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/hospital-o "><i class="fa fa-hospital-o  icon_size3"></i> fa-hospital-o</a></div>
                      <div class="fa-hover col-md-3 col-sm-4"><a href="../icon/medkit "><i class="fa fa-medkit  icon_size4"></i> fa-medkit</a></div>
                    </div>
                  </div>
                </section>
              </div>
          ...
          <div id="animation" class="tab-pane fade">
            <section ng-include="'demo/partials/usage.html'" class="article-content ng-scope">

<br class="ng-scope">
<div class="demo_icon ng-scope">
    <div class="animation">
...
<div class="clear ng-scope"></div></section>
          </div>
        </div>
      </div>
      <!--\\\\\\\ container  end \\\\\\-->
