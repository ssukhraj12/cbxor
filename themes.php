        ...
        <ul>
          <li class="left_nav_active theme_border"><a href="javascript:void(0);"><i class="fa fa-home"></i> DASHBOARD <span class="left_nav_pointer"></span> <span class="plus"><i class="fa fa-plus"></i></span> </a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="themes.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Themes</b> </a> </li>
        ...
        <section class="panel-default">
          <div class="panel">
            <div class="row">
              <div class="col-lg-4 col-sm-6">
                <div class="panel-heading border"><span class="theme_header blue_text">Blue theme</span> </div>
                <div class="panel-body"><img src="images/theme/blue.png" />
                  <h4 class="theme_api">API : <code>blue_thm(true);</code></h4>
                  <h4 class="theme_api">CSS : <code>blue_thm;</code></h4>
                  <button type="button" class="btn btn-primary btn-lg">Apply Here</button>
                </div>
              </div>
              <div class="col-lg-4 col-sm-6">
                <div class="panel-heading border"><span class="theme_header red_text">Red theme</span></div>
                <div class="panel-body"><img src="images/theme/red.png" />
                  <h4 class="theme_api">API : <code>red_thm(true);</code></h4>
                  <h4 class="theme_api">CSS : <code>red_thm;</code></h4>
                  <button type="button" class="btn btn-primary btn-lg">Apply Here</button>
                </div>
              </div>
              
              <div class="col-lg-4 col-sm-6">
                <div class="panel-heading border"><span class="theme_header green_text">green theme</span></div>
                <div class="panel-body"><img src="images/theme/green.png" />
                  <h4 class="theme_api">API : <code>green_thm(true);</code></h4>
                  <h4 class="theme_api">CSS : <code>green_thm;</code></h4>
                  <button type="button" class="btn btn-primary btn-lg">Apply Here</button>
                </div>
              </div>
            </div>
          ...
          <div class="panel">
            <div class="row">
             ...
             <div class="col-lg-4 col-sm-6">
                <div class="panel-heading border"><span class="theme_header magento_text">Magento theme</span> </div>
                <div class="panel-body"><img src="images/theme/mang.png" />
                  <h4 class="theme_api">API : <code>magento_thm(true);</code></h4>
                  <h4 class="theme_api">CSS : <code>magento_thm;</code></h4>
                  <button type="button" class="btn btn-primary btn-lg">Apply Here</button>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-sm-6">
                <div class="panel-heading border"><span class="theme_header">dark theme</span></div>
                <div class="panel-body"><img src="images/theme/dark.png" />
                  <h4 class="theme_api">API : <code>dark_theme(true);</code></h4>
                  <h4 class="theme_api">CSS : <code>dark_theme;</code></h4>
                  <button type="button" class="btn btn-primary btn-lg">Apply Here</button>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-sm-6">
                <div class="panel-heading border"><span class="theme_header light_text">light theme</span> </div>
                <div class="panel-body"><img src="images/theme/light.png" />
                  <h4 class="theme_api">API : <code>light_theme(true);</code></h4>
                  <h4 class="theme_api">CSS : <code>light_theme;</code></h4>
                  <button type="button" class="btn btn-primary btn-lg">Apply Here</button>
                </div>
              </div>
