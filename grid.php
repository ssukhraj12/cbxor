        ...
        <ul>
          ...
          <li class="left_nav_active theme_border"> <a href="javascript:void(0);"> <i class="fa fa-edit"></i> UI KIT <span class="plus"><i class="fa fa-plus"></i></span></a>
            <ul class="opened" style="display:block">
              ...
              <li> <a href="grid.php"> <span>&nbsp;</span> <i class="fa fa-circle theme_color"></i> <b class="theme_color">Grid</b> </a> </li>
      ...
      <div class="container clear_both padding_fix">
        <!--\\\\\\\ container  start \\\\\\-->
          ...
          <div class="panel-heading">
            <h3 class="panel-title"> <i class="fa fa-th"></i> Grid Divisions <span class="options"> <a href="#"> <i class="fa fa-cogs"></i> </a> <a  href="#"> <i class="fa fa-refresh"></i> </a> <a href="#"> <i class="fa fa-chevron-up"></i> </a> <a href="#"> <i class="fa fa-times"></i> </a> </span> </h3>
          </div>
          <br/>
          ...
          <div class="row">
            ...
            <div class="panel-heading">
            <h3 class="panel-title">Mobile, tablet, and desktop</h3>
          </div>
